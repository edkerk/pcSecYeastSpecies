...
protein_info = [protein_info;[{'dummyER'},{'dummyER'},1,1,meanprotein_info(3),meanprotein_info(4),meanprotein_info(5),0,meanprotein_info(7),'c',{''},1,{''},{''},{''}]];% length need to be adjusted to fit the size
...
enzymedataDummyER.proteinExtraMW_specific = enzymedataDummyER.proteinPST.*[0,3346,1080,2009];
enzymedataDummyER.proteinExtraMW = sum(enzymedataDummyER.proteinPST.*[0,3346,1080,2009]);
enzymedataDummyER.proteinMWs = 40000;%
...
for i = 1:length(SecComplex)
    ...
    if contains(coefref_tmp,'proteinLength')
        ...
        elseif height(rxnList) == 2
        enzymedataDummyER.rxnscoef = [enzymedataDummyER.rxnscoef;enzymedataDummyER.proteinLength/467;enzymedataDummyER.proteinLength/467]; % bionumber 105224 average length 
