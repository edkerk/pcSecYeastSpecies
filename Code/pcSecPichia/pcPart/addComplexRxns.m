...
%     model =
%     addReaction(model,rxnid_deg,'metaboliteList',metlist_deg,'stoichCoeffList',coeflist_deg,'reversible',false);
%     %folding和MforSec中有misf
%     
    % complex dilution
    metlist_dil = {cmplxid};
    coeflist_dil = -1;
...
model = addfolding(model,geneList,protein_info); % add folding process for those peptide xx_peptide --> xx_folding %//genelist就对应addfolding中的peptide
