...
if trans == 0 && GPI == 0
    ...
    reaction{2}.rxns = sprintf('%s_COPII_normal_ERGL1A_sec_Sec12p_Sar1p_Shl23p_Lst1p_Erv29p_Bet1p_Bos1p_complex',peptide_org);
    ...
    reaction{2}.rxnNames =  sprintf('%s_s_COPII_normal_ERGL1A_sec_Sec12p_Sar1p_Shl23p_Lst1p_Erv29p_Bet1p_Bos1p_complex Pre budding complex forming for soluble proteins',peptide);
    reaction{3}.rxnNames =  sprintf('%s_COPII_common_ERGLA_Sec12p_Sar1p_Sec23p_Sec24p_Erv29p COPII formation',peptide);
    reaction{4}.rxnNames = sprintf('%s_COPII_common_ERGLA_Ypt1p_Uso1p_Bet3p_Bet5p_Trs20p_Trs23p_Trs31p_Trs33p COPII fusion',peptide);
