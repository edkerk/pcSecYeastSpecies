...
if NG >0
    ...
    reaction{1}.eq = sprintf('%s[er] + %d g3m8mpdol[er] => %s_G3M9[er] + %d dolp[er]',peptide,NG,peptide,NG);
    reaction{2} .eq=  sprintf('%s_G3M9[er] + %d h2o[er] => %s_G2M9[er] + %d glc_D[er]',peptide,NG,peptide,NG);
    reaction{3} .eq=  sprintf('%s_G2M9[er] + %d h2o[er] => %s_G1M9[er] + %d glc_D[er]',peptide,NG,peptide,NG);
    reaction{4} .eq=  sprintf('%s_G1M9[er] + %d h2o[er] => %s_M9[er] + %d glc_D[er]',peptide,NG,peptide,NG);
    reaction{5} .eq=  sprintf('%s_M9[er] + %d h2o[er] => %s_M8[er] + %d man[er]',peptide,NG,peptide,NG);
