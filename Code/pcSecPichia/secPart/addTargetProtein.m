function [model,enzymedata_TP,protein_info] =addTargetProtein(model,TP,new,fakeProteinInfo)
...
% complex_info = protein_info(2:end,[1,10,16,17]);
%protein_kdeg = cell2mat(protein_info(2:end,16));
protein_info = protein_info(2:end,1:15); 
[~,~,protein_info2] = xlsread('Protein_Information_PP.xlsx');
protein_info2 = protein_info2(2:end,1:15);
