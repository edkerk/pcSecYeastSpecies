...
if GPI > 1
  ...
  reaction{1}.eq = sprintf('%s[er] + %d atp[er] + %d h2o[er] => %s_misf[er] + %d adp[er] + %d h[er] + %d pi[er]',peptide,Length,Length,peptide,Length,Length,Length);
...
if DSB > 0
        ...
        reaction{2}.eq=  sprintf('%s_misf[er] + %d gthrd[er] => %s_misf_G1[er] + %d gthox[er] + %d h[er]',peptide,2*DSB,peptide,DSB,2*DSB);
else
...
if NG > 0 
    ...
    reaction{3}.eq =  sprintf('%s_misf_G1[er] + %d h2o[er] => %s_misf_G2[er] + %d man[er]',peptide,NG,peptide,NG);
    ...
    reaction{4}.eq = sprintf('%s_misf_G2[er] + %d h2o[er] => %s_misf_G3[er] + %d man[er]',peptide,NG,peptide,NG);
...
if GPI > 0 
   ...
   if Trans > 0 && strcmp(compartment,'c') && DSB == 0 && NG == 0 % ERADC  
        reaction{6}.rxns = sprintf('%s_ERADC_sec_Ubc6p_Ubc7p_Doa10p_complex',peptide_org);
   ...
   elseif Trans > 0 && (strcmp(compartment,'er')||strcmp(compartment,'erm')) %ERADM 
        ...
        reaction{6}.rxns = sprintf('%s_ERADM_sec_Ubc6p_Ubc7p_Hrd1p_Hrd3p_Der1p_complex',peptide_org);
        reaction{6}.rxnNames = sprintf('%s_sec_Ubc6p_Ubc7p_Hrd1p_Hrd3p_Der1p_complex',peptide);
        reaction{6}.eq = sprintf('%s_misf_G4[er] => %s_misf_G5[er]',peptide,peptide);
        ...
        reaction{8}.rxns = sprintf('%s_ERADM2_sec_Ubc6p_Ubc7p_Doa10p_complex',peptide_org); % paper report that Doa10 can also retro-translocate membrane proteins
        reaction{8}.rxnNames = sprintf('%s_ERADM2_sec_Ubc6p_Ubc7p_Doa10p_complex',peptide);
        reaction{8}.eq = sprintf('%s_misf_G4[er] => %s_misf_G5[er]',peptide,peptide);          
       
   else % ERADL
             
        reaction{6}.rxns = sprintf('%s_ERADL_sec_Ubc6p_Ubc7p_Yos9p_Hrd1p_Hrd3p_Der1p_Usa1p_complex',peptide_org);
   ...
   if NG > 0 
        ...
        reaction{n+1}.eq = sprintf('%s_misf_G6[c] => %s_misfolding[c] + %d man[er] + %d acgam1p[c]',peptide,peptide_org,man,nac);
    elseif NG == 0
        if OG > 0
            reaction{n+1}.rxns = sprintf('%s_ERAD7B_sec_Dsk2p_Rad23p_Png1p_Uba1p_complex',peptide_org);
            reaction{n+1}.rxnNames = sprintf('%s_ERAD_sec_Dsk2p_Rad23p_Png1p_Uba1p_complex',peptide);
            reaction{n+1}.eq = sprintf('%s_misf_G6[c] => %s_misfolding[c] + %d man[er]',peptide,peptide_org,man);
    ...
    if DSB > 0 
        ...
        reaction{n+3}.eq = sprintf('%s_misf[er] + %d gthrd[er] + %d o2[er] => %d h2o2[er] + %d gthox[er] + %s_misf2[er]',peptide,20*DSB,10*DSB,10*DSB,10*DSB,peptide);
    else
    ...
    reaction{n+4}.eq = sprintf('%s_misf2[er] + %d atp[er] + %d h2o[er] => %s_misfolding_acc[er] + %d adp[er] + %d h[er] + %d pi[er]',peptide,10*Length,10*Length,peptide,10*Length,10*Length,10*Length);
