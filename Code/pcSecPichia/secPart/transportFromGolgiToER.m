...
reaction{1}.rxns = sprintf('%s_GLER_COPI_formation_sec_Arf1p_Gea2p_Rer1p_Erd2p_Cop1p_Sec26p_Sec27p_Sec21p_Ret2p_Sec28p_Ret3p_complex',peptide_org);
reaction{2}.rxns = sprintf('%s_GLER_COPI_uncoating_and_fission_sec_Rer1p_Ret2p_Cop1p_Sec27p_Sec21p_Bet1p_complex',peptide_org);


reaction{1}.rxnNames = sprintf('%s_GLER_COPI_formation_Arf1p_Gea2p_Rer1p_Erd2p_Cop1p_Sec26p_Sec27p_Sec21p_Ret2p_Sec28p_Ret3p',peptide);
reaction{2}.rxnNames = sprintf('%s_GLER_COPI_uncoating_and_fission_Rer1p_Ret2p_Cop1p_Sec27p_Sec21p_Bet1p',peptide);


reaction{1}.eq = sprintf('%s[g] + 2 gtp[c] + 2 h2o[c] => %s_COPI_G1[c] + 2 gdp[c] + 2 h[c] + 2 pi[c]',peptide,peptide);
