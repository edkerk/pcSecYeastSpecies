...
reaction{3}.eq= sprintf('%s_translocate_2[c] + 2 gtp[c] + 2 h2o[c] => %s_translocate_3[c] + 2 gdp[c] + 2 pi[c] + h[c]',peptide,peptide);
reaction{4}.eq= sprintf('%s_translocate_2[c] + 2 gtp[c] + 2 h2o[c] => %s_translocate_3[c] + 2 gdp[c] + 2 pi[c] + h[c]',peptide,peptide);
