...
enzymedata.proteins = cellfun(@(x) strrep(x,'-','_'),enzymedata.proteins,'UniformOutput',false);
...
% Kma condition (default)
enzymedata.proteinExtraMW_specific = enzymedata.proteinPST.*[0,5003,1080,2009];
enzymedata.proteinExtraMW = sum(enzymedata.proteinPST.*[0,5003,1080,2009],2); % 0,74% man9glcnan2+26%man41glcnan2,man6,man4etnp2glcnan1(c26)2 % GPI anchor MW from  1970 Da https://pubs.acs.org/doi/10.1021/bi8006324
% % % HNG condition (humanized glycosylation) – use the following line instead:
% % enzymedata.proteinExtraMW_specific = enzymedata.proteinPST.*[0,4928,1080,2009];
% % enzymedata.proteinExtraMW = sum(enzymedata.proteinPST.*[0,4928,1080,2009],2); % 0,man3glcnan4gal2sia2(180*3+942.5*4+180*2+309*2),man6,man4etnp2glcnan1(c26)2 % GPI anchor MW from  1970 Da https://pubs.acs.org/doi/10.1021/bi8006324
% % 
