...
for i = 1:length(model.mets)
    ...
    isGAM = sum(strcmp({'ATP[cytoplasm]','ADP[cytoplasm]','H2O[cytoplasm]','H+[cytoplasm]','phosphate[cytoplasm]'},model.metNames{i})) == 1;
...
if nargin >2
    pos = strcmp(model.rxnNames,'ATP maintenance');%NGAM
