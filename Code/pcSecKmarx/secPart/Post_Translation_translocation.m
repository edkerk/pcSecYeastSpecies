...
reaction{4}.eq= sprintf('%s_translocate_3[c] + %.15f ATP[c] + %.15f H2O[c] => %s[er] + %.15f ADP[c] + %.15f H+[c] + %d phosphate[c]',peptide,Length,Length,peptide,Length,Length,Length);%%.15f---保留小数点15位
end
