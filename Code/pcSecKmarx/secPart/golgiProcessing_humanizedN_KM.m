function [newModel,peptide_name,rxns] = golgiProcessing_humanizedN_KM(model,peptide,peptide_org,Length_total,NG,onlyrxns)
rxns = [];
if NG >0
    Length = Length_total/40;
        ...
        reaction{6}.rxns = sprintf('%s_GLNG_Golgi_N_linked_glycosylation_II_sec_SiaT_complex',peptide_org);
