...
[num_abd, raw_abd, ~] = xlsread('protein_abundance_SCE.xlsx','paxdb');
[num_mw, raw_mw, ~] = xlsread('protein_abundance_SCE.xlsx','uniprot');
...
[~,~,chap]=xlsread('TableS1_SCE.xlsx','Secretory');
