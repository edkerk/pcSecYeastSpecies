...
% 2: yeast nitrogen base without amino acids
desiredExchanges_2 = {'r_1671'; ... % biotin exchange(C10H16N2O3S)
                      'r_2067'; ... % thiamine exchange(C12H17N4OS+)
                      'r_2028'; ... % pyridoxine exchange >high uptake<(C8H11NO3)
                      'r_1967'; ... % nicotinate exchange(C6H4NO2-)
                      'r_1947'; ... % myo-inositol exchange(C6H12O6)
                      'r_1604'; ... % 4-aminobenzoate exchange(C7H6NO2-)
                      'r_1548'; ... % (R)-pantothenate exchange(C9H17NO5)
                      'r_1792'; ... % folic acid exchange(C20H23N7O7)
% % %                       'r_1683'; ... % choline                      
                      'r_2038'};    % riboflavin exchange(C17H20N4O6)
% 3: CSM-Ura
...
% 8 YEP medium
YEP                    =    {'r_1879'; ...% L-arginine exchange
                            'r_1881';...%L-aspartate exchange
                            'r_1889';...%L-glutamate exchange
                            'r_1810';...%L-glycine exchange
                            'r_1893';...%L-histidine exchange
