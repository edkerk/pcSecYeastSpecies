...
for i = 1:length(allname)
    fprintf(fptr,['/home/lizheng/build/bin/soplex  -s0 -g5 -t10000 -f1e-20 -o1e-20 -x -q -c --int:readmode=1 --int:solvemode=2 --int:checkmode=2 --real:fpfeastol=1e-3 --real:fpopttol=1e-3 ',allname{i},' > ', [allname{i},'.out'],' &\n']);
    if mod(i,50)==0
        fprintf(fptr,'wait;\n');
    end
