...
[~,~,protein_machinery]=xlsread('TableS1_SCE.xlsx','Machinery');
...
save('enzymedata_SCE.mat','enzymedata');
save('enzymedataSEC_SCE.mat','enzymedataSEC');
save('enzymedataMachine_SCE.mat','enzymedataMachine');
save('enzymedataDummyER_SCE.mat','enzymedataDummyER');
%% Save model to Excel
model_excel = model;
